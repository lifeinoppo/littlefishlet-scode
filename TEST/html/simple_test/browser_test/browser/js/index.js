webix.type(webix.ui.tree, {
    ...
    columns: {
      config: function() {
        ...
        return [{
          ...
          fillspace: 2,
          template: function(t) {
            for (var i = e.getPathNames(t.id), s = [], n = 0; n < i.length - 1; n++) s.push(i[n].value);
            return s.join("/")
          },
          sort: "string",
          hidden: !0
  ...
  Lx: function(t, e, i) {
    ...
    o && this.xx(o, {
      ...
      if (e && webix.isArray(e))
        for (var i = t.temp.split(","), s = 0; s < e.length; s++) e[s].id && e[s].id != i[s] && this.data.pull[i[s]] && this.data.changeId(i[s], e[s].id)
    })
  },
  ...
  defaults: {
    ...
    templateSize: function(t) {
      for (var e = t.size, i = webix.i18n.filemanager.sizeLabels, s = 0; e / 1024 > 1;) e /= 1024, s++;
